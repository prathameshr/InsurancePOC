...
public abstract class BaseWebApplicationContextTests {
    ...
    protected BillingController billingController;
    ...
    public void initDispatcherServlet() throws Exception{
        ...
        billingController = (BillingController) applicationContext.getBean("billingController");
        billingService = (BillingService)applicationContext.getBean("billingService");
